...
<br/>
<head>
   <i class="fa fa-align-center" aria-hidden="true"></i><b id="login-name">LOGIN Here </b>
</head>
...
<input type="text" class="form-control" id="text2" name="tl" placeholder=" Enter Password">
</div>
</div>
